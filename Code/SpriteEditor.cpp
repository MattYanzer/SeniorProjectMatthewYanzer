...
protected:
	...
	virtual bool OnUserCreate()
	{
		...
		sprite = new olcSprite(16, 32);
		//sCurrentSpriteFile = L"fps_sword.spr";
		//sCurrentSpriteFile = L"fps_key.spr";
		//sCurrentSpriteFile = L"fps_secret.spr";
		//sCurrentSpriteFile = L"fps_fireball.spr";
		//sCurrentSpriteFile = L"fps_threat.spr";
		//sCurrentSpriteFile = L"fps_wall.spr";
		//sCurrentSpriteFile = L"fps_lamp.spr";
		//sCurrentSpriteFile = L"fps_exit.spr";
		//sCurrentSpriteFile = L"fps_vending.spr";
		//sCurrentSpriteFile = L"fps_vending2.spr";
		//sCurrentSpriteFile = L"fps_alarm.spr";
		//sCurrentSpriteFile = L"fps_quarter.spr";
		//sCurrentSpriteFile = L"fps_hide.spr";
		return true;
	}
